    ...
    <div class="card shadow mb-4 col-11 mx-auto">
        <div class="row">
            ...
            <div class="card-header col-12 bg-white my-1">
                ...
                <a href="{{ url('dashboard/produk') }}" type="submit" class="btn float-right btn-sm btn-danger"
                    style="width:33px; font-weight:bold;">X</a>
            </div>

            <div class="card-body">
                <form method="post" action="{{ url('dashboard/produk/'.$produk->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control  @error('deskripsi_produk') is-invalid @enderror"
                            id="deskripsi_produk" placeholder="Masukkan Deskripsi"
                            name="deskripsi_produk">{{old('deskripsi_produk', $produk->deskripsi_produk)}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('size_produk') is-invalid @enderror"
                            ...
                            value="{{old('size_produk', $produk->size_produk)}}">
                        @error('size_produk')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <img src="{{ asset('image/product/'.$produk->gambar_produk) }}" width="250px"
                            class="mx-auto mt-3 mb-3 rounded-lg">
                        <input type="file" name="gambar_produk" class="form-control" id="gambar_produk"
                            value="{{ $produk->gambar_produk }}">
                    </div>
                    {{-- <div class="form-group">
                        <label class="text-dark" for="gambar_produk">Gambar Produk</label>
                        <input type="text" class="form-control @error('gambar_produk') is-invalid @enderror"
                            id="gambar_produk" placeholder="Masukkan Harga Produk" name="gambar_produk"
                    ...
                    <button type="submit" class="btn btn-danger col-lg-12">Ubah Data!</button>
                </form>
            </div>
        </div>
    </div>
