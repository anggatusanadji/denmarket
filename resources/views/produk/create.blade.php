    ...
    <div class="card shadow mb-4 col-11 mx-auto">
      <div class="row">
            ...
            <div class="card-header col-12 bg-white my-1">
                ...
                <a href="{{ url('dashboard/kategori') }}" type="submit" class="btn float-right btn-sm btn-danger" style="width:33px; font-weight:bold;">X</a>
            </div>
            ...
            <div class="card-body">
                <form method="post" action="{{ url('dashboard/produk') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Masukkan Deskripsi" name="deskripsi_produk" value="{{old('deskripsi_produk')}}"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Masukkan Ukuran Produk" name="size_produk" value="{{old('size_produk')}}">
                        @error('size_produk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        placeholder="Masukkan Harga Produk" name="harga_produk" value="{{old('harga_produk')}}">
                        @error('harga_produk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
