    ...
    <div class="card shadow mb-4 col-11 mx-auto">
      <div class="row">
            ...
            <div class="card-header col-12 bg-white my-1">
                <h3 class="mb-0 d-inline text-danger">Form Edit Data Kategori</h3>
                <a href="{{ url('dashboard/kategori') }}" type="submit" class="btn float-right btn-sm btn-danger" style="width:33px; font-weight:bold;">X</a>
            </div>
              
            <div class="card-body">
              <form method="post" action="{{ url('dashboard/kategori/'.$kategori->id) }}">
                  @method('PUT')
                  @csrf
                  ...
                  <button type="submit" class="btn btn-danger col-lg-12">Edit Data!</button>
              </form>
              </div>
